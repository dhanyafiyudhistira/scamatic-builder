> Target: SCADA SVG HMI to add an additional mode: deck-user mode, within ThingsBoard telemetry & RPC.

> This document defines the derived system of deck-user based on the json flow of Node-RED.

## 1. Additional System Overview Based on JSON Flow

This flow defines the flow system of deck-user mode based on the json flow of Node-RED.
