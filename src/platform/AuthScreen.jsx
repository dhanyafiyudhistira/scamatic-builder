  ...
  return (
    <div className={runtime ? 'sb-runtime-login' : 'sb-login-page'}>
      <form className="sb-login-card" onSubmit={submit}>
        ...
        {!desktop && <><div className="sb-auth-divider"><span>or</span></div>
        ...
        {desktop && <small className="sb-auth-hint">Desktop Connected uses the secured email sign-in. Google sign-in remains available in the web edition.</small>}
